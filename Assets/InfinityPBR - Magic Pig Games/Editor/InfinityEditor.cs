...
namespace InfinityPBR
{
    public abstract class InfinityEditor : Editor
    {
        ...
        protected static int LayerField(string label, int layer)
        {
            return EditorGUILayout.LayerField(label, layer);
        }
        
        protected static int LayerField(int layer)
        {
            return EditorGUILayout.LayerField(layer);
        }
        
        protected static int LayerField(string label, int layer, int width)
        {
            return EditorGUILayout.LayerField(label, layer, GUILayout.Width(width));
        }
        
        protected static int LayerField(int layer, int width)
        {
            return EditorGUILayout.LayerField(layer, GUILayout.Width(width));
        }
