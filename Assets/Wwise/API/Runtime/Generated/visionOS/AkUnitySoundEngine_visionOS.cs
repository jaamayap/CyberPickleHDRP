...
public partial class AkUnitySoundEngine {
  ...
  /// <remarks> As per Apple recommendations, the AVAudioSession will be deactivated and then reactivated. Therefore, the primary output device must be reinitialized, which causes all audio to stop for a short period of time. For a seamless transition, call this API during moments of complete silence in your game.</remarks>
  ///
  /// <seealso cref="
  ///  - \ref AkAudioSessionProperties"/>
  /// <param name="in_properties"> New properties to apply to the app's AVAudioSession shared instance.</param>
